        ...
        <DndProvider backend={HTML5Backend}>
          ...
          <div>
            ...
            <div style={{ flex: 1, flexDirection: 'column', marginTop: '10px' }}>
              <div style={{ padding: '20px', borderWidth: '2px', borderStyle: 'solid', borderRadius: '4px', overflow: 'hidden', display: 'inline-block', alignItems: 'flex-start', borderColor: "green", backgroundColor: "green" }}>
