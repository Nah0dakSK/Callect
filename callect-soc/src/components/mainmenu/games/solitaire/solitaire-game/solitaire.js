...
const Game = () => {
  ...
  const [cardBorderColor, setCardBorderColor] = useState('#fff');
        ...
        <DndProvider backend={HTML5Backend}>
          ...
          <div>
            ...
            <div style={{ flex: 1, flexDirection: 'column', marginTop: '10px' }}>
              <div style={{ padding: '20px', borderWidth: '2px', borderStyle: 'solid', borderRadius: '4px', overflow: 'hidden', display: 'inline-block', borderColor: "green", backgroundColor: "green" }}>
              ...
              {/* Stockpile Divs */}
              <div style={{ display: 'flex', flexDirection: 'row', marginLeft: '40px', backgroundColor: "green", borderRadius: "5px" }}>
                <div>
                  <div style={{ marginBottom: 20, color: "white", textAlign: "center" }}>
                    <span className="text2">COLLECTION</span>
                  </div>
                  ...
                  {currentOption === 'normal rules' ?
                    <>
                      {stockpile.length === 0 && <div className="reStock" style={{
                        ...
                        onClick={() => reStock()}
                      >
                        <span style={{ paddingRight: '4px' }}>RESTOCK</span>
                        <Restart width={20} height={20} />
                      </div>}
                    </> :
                    <>
                      {stockpile.length === 0 && <div className="reStock" style={{
                        ...
                        onClick={() => reStock()}
                      >
                        <span style={{ paddingRight: '4px' }}>END</span>
