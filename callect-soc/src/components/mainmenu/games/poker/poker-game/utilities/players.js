...
// Vygenerujte UUID na simuláciu User ID a skutočne získajte zhodu výkonnosti pri viazaní na hráčov pri určovaní výhier
...
// Táto funkcia môže viesť k chybám, ak hráč all in na určitej pozícii
// konečná AI zamrzne
// Zdá sa, že sa to stane, keď odídu len 2 hráči a niekto má all-in
...
const passDealerChip = (state) => {
	// aktívneho hráča, krupiéra a blindy určujeme na základe ľubovoľného indexu, nie pomocou príznakov na záznamoch hráčov.
// Keď odstránime všetkých hráčov, ktorým došli žetóny, nové indexy sa nebudú úplne zhodovať. Potrebujeme nájsť index hráča, sledovať, kto to je resp
...
/* !!!!
 Akciu iniciuje v prvom kole stávok prvý hráč naľavo od blindov. Vo všetkých nasledujúcich kolách stávok sa akcia začína prvým aktívnym hráčom naľavo od tlačidla.
 */
