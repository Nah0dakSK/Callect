        ...
        <DndProvider backend={HTML5Backend}>
          ...
          <div>
            ...
            <div style={{ flex: 1, flexDirection: 'column', marginTop: '10px' }}>
              <div style={{ padding: '20px', borderWidth: '2px', borderRadius: '4px', overflow: 'hidden', display: 'inline-block', border: "solid black", backgroundColor: "green" }}>
              ...
              {/* Stockpile Divs */}
              <div style={{ display: 'flex', flexDirection: 'row', marginLeft: '20px', backgroundColor: "green", border: "solid black" }}>
                <div>
                  <div style={{ marginBottom: 20, color: "white", textAlign: "center" }}>
                    <span className="text2">ZBIERKA</span>
                  </div>
                  ...
                  {currentOption === 'normal rules' ?
                    <>
                      {stockpile.length === 0 && <div className="reStock" style={{
                        ...
                        onClick={() => reStock()}
                      >
                        <span style={{ paddingRight: '4px' }}>PREBRAŤ</span>
                        <Restart width={20} height={20} />
                      </div>}
                    </> :
                    <>
                      {stockpile.length === 0 && <div className="reStock" style={{
                        ...
                        onClick={() => reStock()}
                      >
                        <span style={{ paddingRight: '4px' }}>KONIEC</span>
